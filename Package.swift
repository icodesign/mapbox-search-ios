...
let (coreSearchVersion, coreSearchVersionHash) = ("0.50.0", "c92053e0fb2ce597181ba00e379b3a040f0a8b00b0213ac8b1fea1b6a81971b7")
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(
            ...
            Version(21, 3, 0, prereleaseIdentifiers: ["rc", "beta", "1", "2"])..<Version("22.0.0")
        ),
